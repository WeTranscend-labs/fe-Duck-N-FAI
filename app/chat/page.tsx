...
export default function ChatPage() {
    ...
    const sidebarItems = [
        { icon: <MessageSquare className="h-5 w-5" />, label: "New Chat", onClick: handleNewChat },
        { icon: <History className="h-5 w-5" />, label: "History", onClick: () => { } },
        { icon: <Settings className="h-5 w-5" />, label: "Settings", onClick: () => { } },
        { icon: <HelpCircle className="h-5 w-5" />, label: "Help", onClick: () => { } },
    ];
                ...
                <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 hidden md:block">
                    <div className="container flex h-16 items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-semibold">DuckStrike AI Assistant</h1>
